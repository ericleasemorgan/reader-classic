...
# do the work
	...
	print QUEUE join( "\t", ( TYPE, $shortname, $date, $time, $username, $url ) ), "\n";
	close QUEUE;
...
<div class="col-9 col-m-9">
	...
	<p><strong>##USERNAME##</strong>, your carrel, <strong>##SHORTNAME##</strong> has been queued. Thank you for your submission!</p>
