...
# November 24, 2020 - got to work on Azure; added url; during a pandemic in Lancaster


# configure
use constant FACETFIELD   => ( 'facet_journal', 'year', 'facet_authors', 'facet_keywords', 'facet_entity', 'facet_type', 'facet_sources' );
use constant FIELDS       => 'id,title,doi,urls,date,journal,abstract,sources,pmc_json,pdf_json,sha';
...
use constant EVERYTHING   => "/cord?query=%28+%28+*+NOT+%28+pdf_json%3Anan+%29+%29+OR+%28+*+NOT+%28+pmc_json%3Anan+%29+%29+%29";
