...
# biorxvi2queue.cgi - given a few inputs, add a carrel configuration to the queue
...
# do the work
	...
	move( $file, BACKLOG . "/$name.xml" ) or die "Can't move $file ($!). Call Eric.";
	...
	print QUEUE join( "\t", ( TYPE, $shortname, $date, $time, $email, "$name.xml" ) ), "\n";
	close QUEUE;
...
<html>
<head>
	<title>The Distant Reader - Biorxiv citation file to study carrel</title>
...
<body>
<div class="header">
	<h1>The Distant Reader - Biorxiv citation file to study carrel</h1>
</div>
...
<div class="col-9 col-m-9">
	...
	<p>Use this form to queue a Biorxiv XML citation metada file to be processed by the Distant Reader.</p>
...
<html>
<head>
	<title>Biorxiv to study carrel</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" href="/etc/style.css">
	<style>
		.item { margin-bottom: 1em }
...
<div class="col-9 col-m-9">
	...
	<p>Your carrel has been queued for creation. Thank you for your submission!</p>
