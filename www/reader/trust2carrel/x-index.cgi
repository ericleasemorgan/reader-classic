...
# do the work
	...
	print QUEUE join( "\t", ( TYPE, $shortname, $date, $time, $email, "$name.tsv" ) ), "\n";
	close QUEUE;
...
<html>
<head>
	<title>HathiTrust metadata file to study carrel</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" href="/etc/style.css">
	<style>
		.item { margin-bottom: 1em }
...
<body>
<div class="header">
	<h1>HathiTrust metadata file to study carrel</h1>
</div>
