...
use constant TYPE    => 'urls2carrel';
use constant POSTMAX => 1024 * 1000;
...
# do the work
	...
	move( $file, BACKLOG . "/$name.txt" ) or die "Can't move $file ($!). Call Eric.";
	...
	print QUEUE join( "\t", ( TYPE, $shortname, $date, $time, $username, "$name.txt" ) ), "\n";
	close QUEUE;
